...
series_url = 'https://yugipedia.com/wiki/Category:TCG_and_OCG_series'
...
def display_menu():
    ...
    print("4. Archetype (print to console)")
    print("5. Series (print to console)")
    print("6. Both (print to console)")
    print("7. Archetype minus current.txt (print to console)")
    print("8. Series minus current.txt (print to console)")
    print("9. Both minus current.txt (print to console)")
    print("10. Unique to current.txt (print to console)")
    print("11. Import data from Google Sheets")
    print("12. Exit")
...
while True:
    ...
    if choice == '1':
        ...
        values_array = [row[0] for row in data if row and row[0].strip()]  # Filter out empty rows and cells
